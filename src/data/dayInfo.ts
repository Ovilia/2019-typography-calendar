...
1.4 | Baskerville PT | Baskerville Display PT | 一个人的命运，有时也要考虑历史的行程。| 这是一款比 Times New Roman 更古老更著名的字体。没听说过？那可能是因为它没被操作#系统收入…… |
1.5 | 思源宋体 | Source Han Serif SC | 今日小寒。| 庞大的汉字数量使得制作中文字体的成本高昂，每一款免费中文字体都值得我们珍惜与感恩。 |
1.6 | Bad Script | BadScript-Regular.ttf | 自黑有时候也是门艺术，靠「糟糕的手写体」这个名字成为热门字体也算是自黑的巅峰了吧？ ||
...
1.20 | Gastromond | Gastromond | 今日大寒。 | 这么粗的笔画就像厚实的棉袄一样让人觉得踏#实，天寒地冻的时候也要多穿一些哦！ |
...
3.17 | Comfortaa | Comfortaa-Regular.ttf | 舒服啊啊…… | Comfort 是「舒服」的意思，aa 是「啊啊」的意思。说真的，我应该去做教英语的 App 吧？ |
...
3.31 | Cuisine | CuisineOT | Cuisine 是烹饪的意思，这个字体也很容易让人联想到咖啡或者面包的品牌。 ||
4.1 | Schoolbell | Schoolbell-Regular.ttf | 嘿！张老师叫你去办公室！ | 已经好多年愚人节没被耍了，突然有点怀念起学生时代来…… |
4.2 | Willow | Willow Std | 昔我往矣，杨柳依依；#今我来思，雨雪霏霏。| Willow 是柳树的意思，和这款字体瘦长的形象呼应。|
4.3 | Ohno Blazeface | Ohno Blazeface | 欧，不！又长胖了…… |
4.4 | Asap | Asap-Regular.ttf | 设计师将这款字体与斜体、粗体、粗斜体设计为同样宽度。这样，当在屏幕阅读时切换字形，将不会影响页面的排版。不得不说，真是一种贴心的设计啊！ | ASAP（As Soon As Possible）是尽快的意思。|
...
4.8 | Adobe Heiti | Adobe Heiti Std | 「饮水思源，爱国荣校」| 思源黑体中的中文字符部分便是以 Adobe 黑体为蓝本，至于后半句……庆祝一下母校（上海交通大学）123 岁生日快乐！ |
4.9 | Sign Painter | sign-painter.ttf | Hello, world! | 手写字体的设计常常以练习临摹这样的招牌字体作为入门。 |
4.10 | Mono45 Headline | Mono45-Headline | 0 和 O 傻傻分不清楚？#加一根斜线吧。 ||
4.11 | Lumiere Five | Lumiere Five.otf | 上帝说，要有光。#于是人类发明了灯。| 这款字体的灵感来源于霓虹灯招牌，所以取名为了光。 |
4.12 | Skyhook Mono | SkyhookMono.ttf | 又是一款钢铁直男式的无弧线字体，还特地设计为了等宽字体，以方便在命令行界面中使用——你们是不是对程序员有啥误解…… ||
4.13 | Great Vibes | GreatVibes-Regular.ttf | 想象一下烛光晚餐的菜单上，优雅的字体娓娓道出当晚的美味，是不是很有代入感？ ||
4.14 | Juniper | Juniper Std | 这一款在笔画和衬线中充满了类三角形设计的字体，用一种松树的名字来命名，的确名副其实。||
4.15 | Shuriken Boy | Shuriken Boy Std | 有在衬线里用三角形的，就有在字腔里用三角形的。 ||
4.16 | Trajan Color | Trajan Color | Trajan 本身起源于罗马碑文，而字母中间的白色线条使得雕刻的感觉更加明显。 ||
4.17 | Brioso | Brioso Pro | 衬线有时候就像眉毛——容易被忽#略，但能够传达相当丰富的意味。#Brioso 就是通过使用带弧度的衬线来增加一点活泼的感觉。 ||
...
4.20 | Flood | flood.ttf | 这款字体还原了笔刷末端的纹理，仿佛让你觉得在看公园里的老大爷拿着大号毛笔沾了水在地上写字。 ||
4.21 | Acme | Acme-Regular.ttf | 这个世界上最厉害的应该是汤姆猫，不管被折腾成啥样都能原地满血复#活。| 今天是复活节，祝大家都能找到能治愈自己的东西。|
4.22 | Permanent Marker | Permanent Marker | 它巧妙地模仿了马克笔的效果，以至于看到样稿的时候，脑内浮出的头两个字是「办证」。 ||
4.23 | Bookmania | Bookmania | 今天是「世界图书与版权日」，让我们为图书狂欢吧！ | 字体名称中的 mania 是「狂热」的意思。|
4.24 | CarlMarx | CarlMarx | 这其实是一款 Carl Marx 在包豪斯学习时的字体设计作业。 ||
4.25 | Reross | Reross | 字体设计和几何学其实算是近亲——它们都是从花式尺规作图开始的。| Reross 就是一款纯靠尺规作图完成的字体。 |
4.26 | Joschmi | Joschmi | 是不是觉得昨天和前天的字体风格有点像？他们出自同一门课程的作业，这门课的教师正是 Joschmi。 ||
4.27 | Tinos | Tinos-Regular.ttf  | 根据作者介绍合理猜测，Tinos 大概是 Times New Roman Open Source的隐晦缩写。| 为了节约字体授权费用设计师们也是挺拼的…… |
...
5.31 | Becker Gothics Tuscan | Becker Gothics | 设计在笔画上的切口是不是有点像检票钳留下的缺口？这不得不让人怀疑这字体的灵感是否来自于火车检票。| |
...
6.8 | Ironstrike | Ironstrike | 感受到硬邦邦的钢铁质感了吗？ ||
6.9 | PT Serif | PT_Serif-Web-Regular.ttf | 俄罗斯彼得大帝 1672 年 6 月 9 日出生，这款字体是为了纪念 300 年前彼得大帝下令创建的 Civil Type 字体。||
6.10 | Yeon Sung | YeonSung-Regular.ttf | 这是一款在笔画上模仿书法的字体。 | 觉得和看到的楷书的不太一样？没错，它其实是为韩语设计的。 ||
6.11 | Yesteryear | Yesteryear-Regular.ttf | Yesteryear 来自 1942 年上映的电影《棕榈树的海滩》。 ||
6.12 | B612 | B612-Regular.ttf | 「如果你爱着一朵开在浩瀚星海里的花，那么当你抬头仰望繁星时，便会感到心满意足。」#——《小王子》 | 仰望星空的时候，你看到 B612 星球了吗？ |
6.13 | Graffiti | Graffiti | 这个字体让我想到了街头喷绘艺术。 | Graffiti 是指墙上乱写乱画的东西。 |
6.14 | Alta California | AltaCalifornia | 不要怀疑，它就是同一种字体。 | 虽然我也曾怀疑作者是不是把好几种别的字体各捡一个字符出来凑数…… |
6.15 | Economica | Economica-Regular.ttf | 把放到别的字体里会被当做窄体的宽度当做标准字母宽度，可以说是相当「经济」了。 | |
6.16 | Architects Daughter | ArchitectsDaughter-Regular.ttf | 由笔迹而来的字体多以书写者命名，而它被命名为「建筑师的女儿」，大概是作者感慨于父亲对于女儿的潜移默化的影响吧。| |
6.17 | Black And White Picture | BlackAndWhitePicture-Regular.ttf | 为了高仿黑白扫描件，连噪点都不放过给加上去了。 | |
6.18 | Bounce Script | Bounce Script | 有没有从字体中感受到跳跃的感觉？| 小编点题的求生欲是不是有点太强了…… |
6.19 | Philosopher | Philosopher-Regular.ttf | 「在早期发布时，我故意留了一些纰漏，希望设计师们会逐渐习惯于按需改动而不是被动照搬现有的字体。」 | 这个思路也是没谁了…… |
6.20 | Annie Use Your Telescope | AnnieUseYourTelescope-Regular.ttf | 这其实又是一款笔迹衍生的字体，而作者选择了用她最爱的乐队 Jack's #Mannequin 的一首歌的标题来命名。 | 看来给字体起名字还真是难为设计师们了…… |
6.21 | Lemonada | Lemonada-Regular.ttf | 在这拥有最长白天的夏至的午后，不妨来一杯柠檬汽水放松一下？ | |
6.22 | Waiting for the Sunrise | WaitingfortheSunrise.ttf | 「尽管在设计它的时候我正处于人生低谷时刻，但活泼的它一直提醒着我黑暗之后终将迎来黎明。」 | |
6.23 | Love Ya Like A Sister | LoveYaLikeASister.ttf | 这款类似于儿童涂鸦的字体，源于作者小时候与闺蜜互留的纸条，内容常以「Love Ya Like A Sister」结尾。 | |
...
6.25 | GFS Didot | GFSDidot-Regular.ttf | GFS Didot 来源于 Firmin Didot 于 #1805 年设计的希腊语字体为蓝本。直到 20 世纪末期之前 Didot 一直希腊字母排印的首选。 | |
6.26 | Helvetica Now | Helvetica Now Display Black.otf | 大名鼎鼎的 Helvetica 可能无需任何赘述，毕竟随便一搜都能找到成千上万记载其历史的文字。 ||
6.27 | Chewy | Chewy-Regular.ttf | 「一款很有嚼劲的字体，而且和别的字体不一样，不会嚼多了没味哦。」 | 作者莫不是嚼着某种号称美味持久的口香糖写下了介绍文案？ |
...
8.18 | Dosis | Dosis-Regular.ttf | 圆头的非衬线体总是让人联想到日本街头告示随处可见的圆黑体。 | 日本到处都是圆黑体的一大原因是手工绘制时要比黑体快得多，不知道设计师设计 Dosis 的是不是也是在手绘上省了一点功夫…… |
...
8.22 | Electrolize | Electrolize-Regular.ttf | 相比于 LED 屏幕，早期的火车侧面因为需要切换显示的只有相对固定的终点站信息，所以采用了对使用字体自由度更高的滚动幕布。而设计师们在维持可读性之余，也为这些幕布们设计了风格迥异的字体。 | Electrolize 的灵感来源于某趟俄罗斯的火车上所使用的字体。 |
8.23 | Parisienne | Parisienne-Regular.ttf | Parisienne 起源于上世纪 60 年代一则女性内衣的广告。似乎许多女性用品的广告里都会用文字或画面营造一种「用了……一身轻松」的感觉，不知道算不算一种无意识的偏见呢…… | |
8.24 | Averia Sans Libre | AveriaSansLibre-Regular.ttf | 还记得标准字「Average」吗？#这同样是一款作者拿自己电脑里所有非衬线体计算出来的平均字体，而#Averia 正是西班牙语中「平均」的意思。 | |
8.25 | Marcellus SC | MarcellusSC-Regular.ttf | 如果说罗马碑文是衬线体的起源，而Trajan 作为其中的祖师爷出场（使用授权）费太高的话，Marcellus 是一个不错的选择。 | |
8.26 | Heebo | Heebo-Regular.ttf | 这是一款为希伯来语设计的字体。 | |
8.27 | Rubik Mono One | RubikMonoOne-Regular.ttf | Google 在魔方发明 40 周年的时候启动了 Chrome Cube Lab，允许开发者使用其开源的代码构建一个自己设计贴面的、能够在 Web 页面上自由转动的魔方。而这个项目的衍生产品之一便是这款和魔方及其发明者同名的字体。 | |
8.28 | Frijole | Frijole-Regular.ttf | 一款有点像印章印出来的字体，在试用的时候给自己写了一个大大的——「Accepted」！意外地觉得减压效果还不错。 | |
8.29 | Life Savers | LifeSavers-Regular.ttf | 「Life Saver」是上世纪 50 年代的一个糖果品牌，那时候的广告中使用的字母可都是来自艺术家们亲手绘制，而这款字体展现了其中一条广告上出现的字母的样式。 | |
...
9.2 | Racing Sans One | RacingSansOne-Regular.ttf | 非衬线体诞生之初更流行笔画粗细对比度较大的设计，而随着时代的发展越来越多的人开始偏好等线体。这款字体诞生的初衷便是致敬早期非衬线体的设计。 | |
9.3 | Wire One | WireOne-Regular.ttf | 看了昨天的日历不知道何为等线体？今天就来个例子吧。 | |
...
9.6 | Freckle Face | FreckleFace-Regular.ttf | 「生活中不缺少美，缺少的是发现美的眼睛」 | 作者受自己最爱的饮料的瓶身设计启发创作了这款字体，而我就一般只把饮料当快乐水= = |
9.7 | Pompiere | Pompiere-Regular.ttf | 一般而言为了可读性，字体的x字高都会不低于上升部。而Pompiere则反其道而行之，虽然牺牲了小字号下的可读性，却在大字号下收获了意外的有趣感。 | |
9.8 | Happy Monkey | HappyMonkey-Regular.ttf | 周末宜逛动物园放松身心。不知道这款轻松的字体能不能让你联想到正在吃香蕉的猴子脸上浮现的快乐的表情呢？ | |
9.9 | Crimson Text | CrimsonText-Regular.ttf | 「这世界上有许多免费的字体，但绝大多数都是抠门的甲方（不肯买字体）让搞出来的Times New Roman和Helvetica的替代品，还做的不咋滴」 | 相比于那些更为所有人所熟知的字体，Garamond风格的字体确实使用者和仿作都不算很多。字体的命运，还是要看历史的进程。|
...
9.14 | Sue Ellen Francisco | SueEllenFrancisco-Regular.ttf | 许多由笔迹衍生而来的字体通常依旧会经历在造字软件中被调整细节的过程，而Sue Ellen Francisco则是作者完完全全在Illustrator中直接使用数位板书写而成。 | |
9.15 | Kite One | KiteOne-Regular.ttf | 毕竟文字是用来阅读的，如何提高字体在大段文字场景下的阅读舒适度也是一个亘古不变的话题。而作者用Kite One提出了一个观点，字母在向右倾斜7度的时候最适宜阅读。 | |
9.16 | Sirin Stencil | SirinStencil-Regular.ttf | 听说你们爱在PPT里用立体字？那自带3D效果的字体可不能错过。 | |
9.17 | Poly | Poly-Regular.ttf | 这款字体最初为那些动不动就充满了（由大堆词根拼接而成的）长单词的文章而设计，通过调整x字高和字符间距使得其相比于普通的字体在同等字号下更节约空间。 | 听上去很适合动不动就写长句子的我，但是可惜它没有中文款... |
9.18 | 站酷快乐体 | ZCOOLKuaiLe-Regular.ttf | 站酷快乐体是站酷第二款以众人合作的方式完成的字体。至于第一款是啥，暂时先卖个关子。 | |
9.19 | Yatra One | YatraOne-Regular.ttf | Yatra在印度教里意为「朝圣之旅」。用这样一款为梵文设计的字体抄写经文是不是可能有额外的功效加成… | |
9.20 | Limelight | Limelight-Regular.ttf | 之前曾提到在非衬线字体诞生之初多流行笔画粗细对比强烈的字体，而当年的百老汇和好莱坞在推动这一潮流的过程中功不可没。这也是许多类似的字体以Broadway命名的缘故。 | |
